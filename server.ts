...
La démonstration de force de Shanks à Elbaf, pulvérisant Eustass Kid d'une seule attaque « Kamusari » (le Départ Divin hérité de Gol D. Roger), prouve que sa puissance est sans égale. Nos rédacteurs spéculent que la route menant à Raftel passera par un duel fraternel entre Shanks et son protégé, Monkey D. Luffy. Le chapeau de paille que Luffy porte sur la tête scellera-t-il une promesse de renouveau ou l'affrontement le plus tragique de l'ère de la piraterie ?`,
  ...
  },
  {
    ...
    summary: "Notre journaliste analyse la révolution économique menée par Baggy, Crocodile et Mihawk.",
...
- **Uranus :** Cette arme céleste destructrice réside entre les mains secrètes d'Im, le souverain de l'ombre à Marie-Joie. Alimentée par la source d'énergie Mother Flame volée à Vegapunk, elle a démontré sa terrifiante capacité à pulvériser une nation entière des cartes en quelques secondes !
...
app.get("/api/wej/generate-daily", async (req, res) => {
  try {
    ...
    const topics = [
      ...
      // 📺 Actualités Anime (Toei Animation)
      ...
      // 🎬 Actualités Netflix (Séries & Remake)
      ...
      // 🇫🇷 Actualités Parutions Françaises (Glénat)
      ...
      // ❓ Top 50 Questions Mythiques & Légendaires
...
Le focus actuel reste centré sur les révélations géopolitiques autour d'Egghead et la marche triomphale vers Elbaf. Les chapitres officiels sont consultables de façon légitime sur l'application officielle MANGA Plus, garantissant des traductions impeccables et un accès en temps réel dès la parution au Japon.`,
      ...
      "le concept du Haki des Rois (Haoshoku) et les personnages légendaires qui le maîtrisent": {
        ...
        summary: "Décryptage ciblé de l'énergie spirituelle des conquérants, un pouvoir d'esprit qu'un être sur un million possède dès l'enfance.",
...
C'est le moyen idéal d'incarner chaque membre du Chapeau de Paille avec de véritables compétences fidèles au manga. Un pur moment d'exploration d'une beauté saisissante !`,
